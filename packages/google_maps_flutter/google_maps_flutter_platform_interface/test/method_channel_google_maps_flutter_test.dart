...
import 'package:google_maps_flutter_platform_interface/method_channel_google_maps_flutter.dart';
...
void main() {
  ...
  group('$MethodChannelGoogleMapsFlutter', () {
    ...
    final MethodChannelGoogleMapsFlutter map = MethodChannelGoogleMapsFlutter();
